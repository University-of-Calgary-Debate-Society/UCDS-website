...
export default function DiscordTermsAndPrivacy() {
  return (
    <main style={{ background: '#000000', minHeight: '90vh', fontFamily: 'SFMono-Regular, Consolas, "Liberation Mono", Menlo, monospace', display: 'flex', alignItems: 'center', padding: '4rem 1rem' }}>
      <div className="container" style={{ maxWidth: '850px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2.5rem', borderBottom: '1px solid #39ff14', paddingBottom: '1.5rem' }}>
            <span style={{ 
              fontSize: '0.85rem', 
          ...
          <div style={{ 
            ...
            <hr style={{ border: 'none', borderTop: '1px solid rgba(57, 255, 20, 0.25)', margin: '1rem 0' }} />

            {/* TERMS OF SERVICE SECTION */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#39ff14" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
              <h2 style={{ fontSize: '1.5rem', color: '#ffffff', margin: 0, fontWeight: 800 }}>Terms of Service</h2>
            </div>

            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>1. Scope of Service</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>2. Server Eligibility & Installation</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>3. Acceptable Use</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>4. Termination & Availability</h3>
            <p>
            ...
            <hr style={{ border: 'none', borderTop: '1px solid rgba(57, 255, 20, 0.25)', margin: '1.5rem 0' }} />

            {/* PRIVACY POLICY SECTION */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#39ff14" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
              <h2 style={{ fontSize: '1.5rem', color: '#ffffff', margin: 0, fontWeight: 800 }}>Privacy Policy</h2>
            </div>

            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>1. Data We Collect</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>2. How We Use Data</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>3. Security & Access Control</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>4. Data Deletion</h3>
            <p>
            ...
            <h3 style={{ fontSize: '1.15rem', color: '#39ff14', margin: '0.5rem 0 0.25rem', fontWeight: 700 }}>5. Contact & Inquiries</h3>
            <p>
              For legal inquiries, terms compliance questions, or data purge requests, contact the UCDS board at <a href="mailto:ucds.debate@gmail.com" style={{ color: '#39ff14', textDecoration: 'underline' }}>ucds.debate@gmail.com</a>.
            </p>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', borderTop: '1px solid rgba(57, 255, 20, 0.25)', paddingTop: '1.5rem' }}>
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = '#39ff14'; e.currentTarget.style.borderColor = '#39ff14'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(57, 255, 20, 0.4)'; }}
            onMouseLeave={(e) => { e.currentTarget.style.background = '#ffffff'; e.currentTarget.style.borderColor = '#ffffff'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(255, 255, 255, 0.2)'; }}>
              Back to Invite
            </Link>
          </div>
        </div>
